        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">{{ $control }} <a href="javascript:void(0)" class="btn btn-success float-right" id="add_newproject_btnid" onclick="showAddNewProjectModal()">Add Project</a></h4>
            </div>
            <div class="card-body">
